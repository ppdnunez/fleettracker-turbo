...
const numStyle       = (w) => ({ ...inputStyle, width: w ?? 90 });
...
function SwitchAndMethod({ enabled, setEnabled, method, setMethod }) {
    return (
        <>
            <div>
...
function NumField({ label, value, onChange, min, max, width }) {
    return (
        <div>
            <label style={labelStyle}>{label}</label>
            <input type="number" min={min} max={max} value={value} onChange={e => onChange(e.target.value)} style={numStyle(width)} />
        </div>
    );
}
 ...
 */
export default function DrivingBehaviorAlertModal({ imei, deviceName, onClose }) {
    ...
    return (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1100 }}>
            <div style={{ background: '#fff', borderRadius: 12, width: 620, maxHeight: '90vh', display: 'flex', flexDirection: 'column', boxShadow: '0 24px 64px rgba(0,0,0,0.3)' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px', borderBottom: '1px solid #f1f5f9', flexShrink: 0 }}>
                    <div>
                        <h2 style={{ margin: 0, fontSize: 15, fontWeight: 700, color: '#0f172a' }}>Driving Behavior Alerts</h2>
                ...
                <div style={{ flex: 1, overflowY: 'auto', padding: 20 }}>
                    ...
                    <div style={sectionStyle}>
                        ...
                        <p style={{ margin: '10px 0 0', fontSize: 11.5, color: '#9ca3af' }}>Triggers if speed continuously exceeds the threshold for the full detection window.</p>
                    </div>
                    ...
                    <div style={sectionStyle}>
                        ...
                        <p style={{ margin: '10px 0 0', fontSize: 11.5, color: '#9ca3af' }}>Triggers if GPS speed changes by more than the threshold within the detection window (either direction).</p>
                    </div>
                    ...
                    <div style={sectionStyle}>
                        ...
                        <p style={{ margin: '10px 0 0', fontSize: 11.5, color: '#9ca3af' }}>Triggers when speed is at/above the threshold and heading changes by more than the angle within the detection window.</p>
                    </div>
                    ...
                    <div style={sectionStyle}>
                        ...
                        <p style={{ margin: '10px 0 0', fontSize: 11.5, color: '#9ca3af' }}>Requires Collision Alert (above) to be enabled on the device — otherwise this setting has no effect.</p>
                    </div>
                    ...
                    <div style={{ ...sectionStyle, marginBottom: 0 }}>
                        ...
                        <p style={{ margin: '10px 0 0', fontSize: 11.5, color: '#9ca3af' }}>Alert resets once ACC has been off for the configured rest time.</p>
                    </div>
