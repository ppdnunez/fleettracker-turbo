...
<body style="font-family: Arial, sans-serif; color: #1f2937; background: #f3f4f6; padding: 24px;">
    <div style="max-width: 480px; margin: 0 auto; background: #ffffff; border-radius: 10px; padding: 28px; border: 1px solid #e5e7eb;">
        <h2 style="margin: 0 0 4px; font-size: 17px; color: #b45309;">Vehicle Maintenance Due</h2>
        <p style="margin: 0 0 20px; font-size: 13px; color: #6b7280;">FleetTrack maintenance reminder</p>
        ...
        <table style="width: 100%; font-size: 13px; border-collapse: collapse;">
            ...
            <tr>
                ...
                <td style="padding: 6px 0;">{{ implode(' · ', $reasons) }}</td>
            </tr>
        </table>

        <p style="margin: 24px 0 0; font-size: 12px; color: #9ca3af;">
            Mark this complete in FleetTrack (Fleet &rarr; Vehicle Maintenance) once serviced.
        </p>
    </div>
</body>
</html>
